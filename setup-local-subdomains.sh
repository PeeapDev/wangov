...
echo "  • http://tax.localhost:3003 (Tax Authority Portal)"
echo "  • http://education.localhost:3003 (Education Portal)"
echo "  • http://health.localhost:3003 (Health Portal)"
echo "  • http://edsa.localhost:3003 (EDSA Portal)"
echo "  • http://nassit.localhost:3003 (NASSIT Portal)"
echo "  • http://mbsse.localhost:3003 (MBSSE Portal)"
echo ""
echo "Main portal: http://localhost:3003"
echo ""

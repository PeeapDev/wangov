    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">WanGov-ID</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/data-protection" className="text-gray-300 hover:text-white">Data Protection</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-start">
                ...
                <span>Ministry of Information and Communications<br />Youyi Building, Brookfields<br />Freetown, Sierra Leone</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span>info@wangov-id.gov.sl</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="mt-8 pt-6 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">
              © {new Date().getFullYear()} WanGov-ID. All rights reserved. Government of Sierra Leone.
            </p>
